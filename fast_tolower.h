 ...
 *                 with minimal branching and CPU.
 *
 *
 ...
 *  - XOR the difference
 *
 *  (Disclaimer: was first made aware of this here: http://codegolf.stackexchange.com/questions/36425/convert-to-uppercase-and-lowercase-without-branching-and-comparisons)
 *
